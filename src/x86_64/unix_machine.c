...
void register_other_syscalls(struct syscall *map)
{
    ...
    register_syscall(map, fork, 0, 0);
    register_syscall(map, vfork, 0, 0);
    ...
    register_syscall(map, getpgrp, 0, 0);
    ...
    register_syscall(map, mknod, 0, 0);
    register_syscall(map, uselib, 0, 0);
    register_syscall(map, personality, 0, 0);
    register_syscall(map, ustat, 0, 0);
    register_syscall(map, sysfs, 0, 0);
    ...
    register_syscall(map, modify_ldt, 0, 0);
    register_syscall(map, pivot_root, 0, 0);
    register_syscall(map, _sysctl, 0, 0);
    ...
    register_syscall(map, iopl, 0, 0);
    register_syscall(map, ioperm, 0, 0);
    register_syscall(map, create_module, 0, 0);
    register_syscall(map, init_module, 0, 0);
    register_syscall(map, delete_module, 0, 0);
    register_syscall(map, get_kernel_syms, 0, 0);
    register_syscall(map, query_module, 0, 0);
    register_syscall(map, quotactl, 0, 0);
    register_syscall(map, nfsservctl, 0, 0);
    register_syscall(map, getpmsg, 0, 0);
    register_syscall(map, putpmsg, 0, 0);
    register_syscall(map, afs_syscall, 0, 0);
    register_syscall(map, tuxcall, 0, 0);
    register_syscall(map, security, 0, 0);
    ...
    register_syscall(map, set_thread_area, 0, 0);
    register_syscall(map, io_cancel, 0, 0);
    register_syscall(map, get_thread_area, 0, 0);
    register_syscall(map, lookup_dcookie, 0, 0);
    register_syscall(map, epoll_ctl_old, 0, 0);
    register_syscall(map, epoll_wait_old, 0, 0);
    ...
    register_syscall(map, futimesat, 0, 0);
