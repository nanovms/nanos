...
void register_net_syscalls(struct syscall *map)
{
    ...
    register_syscall_nolock(map, accept, accept);
    register_syscall_nolock(map, accept4, accept4);
    ...
    register_syscall_nolock(map, setsockopt, setsockopt);
    register_syscall_nolock(map, getsockname, getsockname);
